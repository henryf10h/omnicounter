...
def main():
    ...
    estimate_fees=endpoint.estimateFees(config['networks']['polygon-test']['chainId'],config['networks']['polygon-test']['srcAddress'],"0x",False,"0x00010000000000000000000000000000000000000000000000000000000000030d40",{'from':account})
    print(estimate_fees)